...
const jsFunctionInfo = React.createElement("div", null, t('For more information about objects are in context in the scope of this function, refer to the'), React.createElement("a", {
  href: sandboxUrl
...
function jsFunctionControl(label, description, extraDescr, height, defaultText) {
  ...
  return {
    ...
    mapStateToProps: state => ({
      ...
      warning: !state.common.conf.ENABLE_JAVASCRIPT_CONTROLS ? t('This functionality is disabled in your environment for security reasons.') : null,
...
export const jsDataMutator = {
  ...
  config: jsFunctionControl(t('Javascript data interceptor'), t('Define a javascript function that receives the data array used in the visualization ' + 'and is expected to return a modified version of that array. This can be used ' + 'to alter properties of the data, filter, or enrich the array.'))
};
export const jsTooltip = {
  name: 'js_tooltip',
  config: jsFunctionControl(t('Javascript tooltip generator'), t('Define a function that receives the input and outputs the content for a tooltip'))
};
export const jsOnclickHref = {
  name: 'js_onclick_href',
  config: jsFunctionControl(t('Javascript onClick href'), t('Define a function that returns a URL to navigate to when user clicks'))
};
...
export const mapboxStyle = {
  ...
  config: {
    ...
    clearable: false,
    renderTrigger: true,
    choices: [['mapbox://styles/sertech/ckp3d5qfl1j1k18petrtmzyef','municipios'], ['mapbox://styles/sertech/ckrmn256p2l3618lh5365se00','secciones_gto'], ['mapbox://styles/mapbox/streets-v9', 'Streets'], ['mapbox://styles/mapbox/dark-v9', 'Dark'], ['mapbox://styles/mapbox/light-v9', 'Light'], ['mapbox://styles/mapbox/satellite-streets-v9', 'Satellite Streets'], ['mapbox://styles/mapbox/satellite-v9', 'Satellite'], ['mapbox://styles/mapbox/outdoors-v9', 'Outdoors']],
